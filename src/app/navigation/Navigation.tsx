...
const WrappedOperationsPage = withSuspenseAndErrorBoundary(
  lazy(() => import('src/pages/operations/ui/OperationsPage'))
);
export const Navigation = () => {
  return (
    <Routes>
      ...
      <Route path="/operations" element={<WrappedOperationsPage />} />
